...
3. If you using apisix below v2.0, note that the v2 API store and v3 API store are [separate and isolated](https://etcd.io/docs/v3.4.0/op-guide/v2-migration/). Apisix-dashboard v2.0 and above use the etcd v3 API, apisix 1.5 and below use the etcd v2 API.
